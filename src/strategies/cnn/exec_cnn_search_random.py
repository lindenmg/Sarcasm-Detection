...
def __main__():
    ...
    executor = SearchExecutor(param_iterator, executor_logger, executor_cacher, 'random_search')
    executor.run()
...
def get_variation_list():
    ...
    return [
        ...
        {'keys': ['cv_iterator_factory', 'args', 'batch_search_window'], 'min': 1, 'max': 10, 'quantity_type': 'int'},
